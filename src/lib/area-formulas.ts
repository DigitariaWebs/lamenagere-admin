 ...
 *
 * This module mirrors the server's `common/pricing/area-formulas.ts` and the
 * mobile app's `lib/area-formulas.ts`. Keep the three in sync — the back office
 * only picks a formula, but it must describe exactly what the server will bill.
 */
